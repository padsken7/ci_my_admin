...
<?php $this->load->view('admin/inc/left_sidebar_inc') ?>
			...
			<div class="span9">
				...
				<form action="http://lukoil.denwer/admin/panel/create/<?=$table_name?>" method="post" accept-charset="utf-8" class="form-horizontal">
				<legend><?php echo $this->admin->tables[$table_name]['add']; ?></legend>
				
				<?=$fields?>
				
				<div class="control-group">
					<div class="controls"><button type="submit" class="btn btn-large">добавить</button></div>
				</div>
